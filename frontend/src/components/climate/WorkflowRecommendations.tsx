    ...
    switch (currentPage) {
      case "dashboard":
        ...
        list.push({
          ...
          desc: "Consult Paryavaran Copilot on regional indicators"
        });
        break;
      ...
      case "analytics":
        list.push({
          ...
          desc: "Analyze gridded chart values using Paryavaran Copilot"
        });
        list.push({
      ...
      case "simulator":
        ...
        list.push({
          ...
          desc: "Consult Paryavaran Copilot on simulated paths"
        });
        list.push({
          label: "Open Risk Center",
          icon: ShieldAlert,
      ...
      case "reports":
        list.push({
          label: "Discuss Report with Paryavaran Copilot",
          icon: Bot,
          onClick: () => {
