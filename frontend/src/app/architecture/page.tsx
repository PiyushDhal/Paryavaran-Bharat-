  ...
  return (
    <div className="space-y-16">
      ...
      <div className="max-w-4xl space-y-6">
        <div className="inline-flex items-center gap-2 rounded-full border border-white/[0.08] bg-brand-blue/10 px-4 py-1.5 text-xs font-bold uppercase tracking-widest text-brand-blue backdrop-blur-md">
            ...
            return (
              ...
              >
                <div className={`w-14 h-14 mx-auto rounded-2xl flex items-center justify-center border ${
                  isEmerald
                    ? "bg-brand-blue/10 text-brand-blue border-white/[0.08]"
                    : "bg-brand-blue/10 text-brand-blue border-white/[0.08]"
                }`}>
                  <Icon className="w-7 h-7" />
                </div>
                <div>
                  <h3 className={`font-bold text-lg ${isEmerald ? "text-brand-blue" : "text-white"}`}>{step.title}</h3>
          ...
          {pipelineSteps2.map((step) => {
            ...
            return (
              <div key={step.title} className="glass-panel p-8 rounded-2xl text-center space-y-4 step-node shadow-glow">
                <div className="w-14 h-14 mx-auto rounded-2xl bg-brand-blue/10 flex items-center justify-center text-brand-blue border border-white/[0.08]">
                  <Icon className="w-7 h-7" />
                </div>
                <div>
            ...
            <div key={model.name} className={`glass-card rounded-2xl p-6 hover:border-${model.color}-400/30 transition-all`}>
              <div className="flex items-center justify-between mb-4">
                <span className={`px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wider border ${
                  model.color === "emerald" ? "bg-brand-blue/10 text-brand-blue border-white/[0.08]" :
